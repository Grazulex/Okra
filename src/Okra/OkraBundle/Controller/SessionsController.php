...
class SessionsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('OkraBundle:Sessions')->findAll();

        return $this->render('OkraBundle:Sessions:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('OkraBundle:Sessions:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('OkraBundle:Sessions')->find($id);
        ...
        return $this->render('OkraBundle:Sessions:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('OkraBundle:Sessions:edit.html.twig', array(
            'entity'      => $entity,
